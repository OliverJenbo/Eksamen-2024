...
public class CompetitionController {
    ...
    public List<AthleteDTO> getAcceptedAthletes(@PathVariable int competitionId) {
        return competitionService.getAcceptedAthletes(competitionId);
    }
    @GetMapping("/{competitionId}/athletes/invited")
    public List<AthleteDTO> getInvitedAthletes(@PathVariable int competitionId) {
        return competitionService.getInvitedAthletes(competitionId);
    }
    @GetMapping("/{competitionId}/athletes/checked-in")
    public List<AthleteDTO> getCheckedInAthletes(@PathVariable int competitionId) {
